...
TB67H420FTG driver(6, 5, 21, 7, 8, 22); // Set the INA1, INA2, PWMA, INB1, INB2, PWMB pins (in that order)
...
QTRSensorsAnalog qtra((unsigned char[]) { 14, 15, 16, 17, 18, 19 }, NUM_SENSORS, NUM_SAMPLES_PER_SENSOR, EMITTER_PIN);
